      ...
      for(vidType v1:y0f0)      {
        ...
        for(vidType v2:y0y1)        {
          ...
          for(vidType v3:y0y1n2f2)          {
            ...
            for(vidType v4:n0n1y2n3)            {
              VertexSet y4 = g.N(v4);
              counter[0] += difference_num(n0n1n2y3, y4);
            }
          }
        }
      }
...
const uint64_t data_complexity = 1.48154e+07;
const uint64_t time_complexity = 1.14777e+07;
