        ...
        for(vidType v2:y0f0y1f1)        {
          ...
          for(vidType v3:y0y1y2)          {
            ...
            for(vidType v4:y0y1y2y3f3)            {
              VertexSet y4 = g.N(v4);
              VertexSet y0y1y2n3n4 = difference_set(y0y1y2n3, y4);
              VertexSet y0y1y2y3f3y4f4 = intersection_set(y0y1y2y3f3, y4, v4);
              for(vidType v5:y0y1y2y3f3y4f4)              {
                VertexSet y5 = g.N(v5);
                counter[0] += difference_num(y0y1y2n3n4, y5);
              }
            }
          }
        }
