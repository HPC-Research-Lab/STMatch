      ...
      for(vidType idx2 = 0; idx2 < y0f0y1f1.size(); idx2++) {
        ...
        for(vidType idx3 = 0; idx3 < y0f0y1f1y2f2.size(); idx3++) {
          ...
          for(vidType idx4 = 0; idx4 < y0f0y1f1y2f2y3f3.size(); idx4++) {
            ...
            VertexSet y4 = g.N(v4);
            VertexSet y0f0y1f1y2f2y3f3y4f4 = intersection_set(y0f0y1f1y2f2y3f3, y4, v4);
            for(vidType idx5 = 0; idx5 < y0f0y1f1y2f2y3f3y4f4.size(); idx5++) {
              vidType v5 = y0f0y1f1y2f2y3f3y4f4.begin()[idx5];
              VertexSet y5 = g.N(v5);
              counter[0] += intersection_num(y0f0y1f1y2f2y3f3y4f4, y5, v5);
            }
          }
        }
      }
