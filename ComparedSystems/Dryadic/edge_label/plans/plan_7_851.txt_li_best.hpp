          ...
          for(vidType v3:y0y1y2l3)          {
            ...
            for(vidType v4:y0y1y2y3l4)            {
              ...
              for(vidType v5:y0y1y2y3y4l5)              {
                ...
                counter[0] += difference_num(y0y1y2y3y4l6, y5l6);
              }
            }
          }
        }
        ...
        for(vidType v2:y0y1l1)        {
          ...
          for(vidType v3:y0y1y2l3)          {
            ...
            for(vidType v4:y0y1y2y3l4)            {
              ...
              for(vidType v5:y0y1y2y3y4l5)              {
                VertexSet y5l6 = g.N(v5,6);
                counter[1] += difference_num(y0y1y2y3y4l6, y5l6);
              }
            }
          }
        }
...
const uint64_t data_complexity = 5.83707e+09;
const uint64_t time_complexity = 6.07488e+09;
