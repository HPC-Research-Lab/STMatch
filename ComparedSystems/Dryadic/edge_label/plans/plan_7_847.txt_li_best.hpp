          ...
          for(vidType v3:y0y1y2l4)          {
            ...
            for(vidType v4:y0y1y2y3l5)            {
              ...
              for(vidType v5:y0y1n2y3y4l3)              {
                ...
                counter[0] += intersection_num(y0y1y2n3n4l6, y5l6);
              }
            }
          }
        }
          ...
          for(vidType v3:y0y1y2l4)          {
            ...
            for(vidType v4:y0y1y2y3l5)            {
              ...
              for(vidType v5:y0n1y2y3y4l3)              {
                VertexSet y5l6 = g.N(v5,6);
                counter[1] += intersection_num(y0y1y2n3n4l6, y5l6);
              }
            }
          }
        }
          ...
          for(vidType v3:y0y1y2l2)          {
            ...
            for(vidType v4:y0y1y2y3l5)            {
              ...
              for(vidType v5:y0y1y2n3y4l3)              {
                VertexSet y5l6 = g.N(v5,6);
                counter[1] += intersection_num(y0n1y2y3n4l6, y5l6);
              }
            }
          }
        }
        ...
        for(vidType v2:y0y1l1)        {
          ...
          for(vidType v3:y0y1y2l2)          {
            ...
            for(vidType v4:y0y1y2y3l5)            {
              ...
              for(vidType v5:y0y1y2n3y4l3)              {
                VertexSet y5l6 = g.N(v5,6);
                counter[1] += intersection_num(n0y1y2y3n4l6, y5l6);
              }
            }
          }
        }
        ...
        for(vidType v2:y0y1l0)        {
          ...
          for(vidType v3:y0y1y2l1)          {
            ...
            for(vidType v4:y0y1y2y3l2)            {
              VertexSet y4l3 = g.N(v4,3);
              VertexSet y0y1y2y3n4l3 = difference_set(y0y1y2y3l3, y4l3);
              VertexSet y4l6 = g.N(v4,6);
              VertexSet n0n1y2y3y4l6 = intersection_set(n0n1y2y3l6, y4l6);
              for(vidType v5:y0y1y2y3n4l3)              {
                VertexSet y5l6 = g.N(v5,6);
...
const uint64_t data_complexity = 6.11767e+09;
const uint64_t time_complexity = 5.44512e+09;
