  ...
  counter.resize(n_counters, 0);
      ...
      for(vidType v1:y0l2)      {
        ...
        for(vidType v2:y0y1l3)        {
          ...
          for(vidType v3:n0y1y2l1)          {
            ...
            VertexSet n0n1n2y3l4; difference_set(n0n1n2y3l4,difference_set(n0n1n2y3l4,difference_set(n0n1n2y3l4,y3l4, y0l4), y1l4), y2l4);
            VertexSet y3l5 = g.N(v3,5);
            VertexSet y0n1n2n3l5 = difference_set(y0n1n2l5, y3l5);
            for(vidType v4:y0n1n2n3l5)            {
              VertexSet y4l4 = g.N(v4,4);
              counter[0] += difference_num(n0n1n2y3l4, y4l4);
            }
          }
        }
      }
      for(vidType v1:y0l3)      {
        ...
        for(vidType v2:y0y1l2)        {
          ...
          for(vidType v3:n0y1y2l1)          {
            ...
            for(vidType v4:y0n1n2n3l5)            {
              VertexSet y4l4 = g.N(v4,4);
              counter[1] += difference_num(n0n1n2y3l4, y4l4);
            }
          }
        }
      }
        ...
        for(vidType v2:y0n1l2)        {
          ...
          for(vidType v3:y0n1y2l3)          {
            ...
            for(vidType v4:n0n1y2y3l1)            {
              VertexSet y4l4 = g.N(v4,4);
              VertexSet n0n1n2n3y4l4; counter[1] += difference_num(difference_set(n0n1n2n3y4l4,difference_set(n0n1n2n3y4l4,difference_set(n0n1n2n3y4l4,y4l4, y0l4), y1l4), y2l4), y3l4);
            }
          }
        }
      }
    ...
    for(vidType v0:l1)    {
      ...
      for(vidType v1:y0l2)      {
        ...
        for(vidType v2:y0y1l3)        {
          ...
          for(vidType v3:n0y1y2l0)          {
            ...
            VertexSet y3l5 = g.N(v3,5);
            VertexSet n0n1n2y3l5; difference_set(n0n1n2y3l5,difference_set(n0n1n2y3l5,difference_set(n0n1n2y3l5,y3l5, y0l5), y1l5), y2l5);
            for(vidType v4:y0n1n2n3l4)            {
              VertexSet y4l5 = g.N(v4,5);
              counter[1] += difference_num(n0n1n2y3l5, y4l5);
            }
          }
        }
      }
      ...
      for(vidType v1:y0l4)      {
        ...
        for(vidType v2:y0n1l2)        {
          VertexSet y2l0 = g.N(v2,0);
          VertexSet n0n1y2l0; difference_set(n0n1y2l0,difference_set(n0n1y2l0,y2l0, y0l0), y1l0);
          VertexSet y2l3 = g.N(v2,3);
          VertexSet y0n1y2l3 = intersection_set(y0n1l3, y2l3);
          VertexSet y2l5 = g.N(v2,5);
          for(vidType v3:y0n1y2l3)          {
            VertexSet y3l0 = g.N(v3,0);
            VertexSet n0n1y2y3l0 = intersection_set(n0n1y2l0, y3l0);
            VertexSet y3l5 = g.N(v3,5);
            for(vidType v4:n0n1y2y3l0)            {
              VertexSet y4l5 = g.N(v4,5);
              VertexSet n0n1n2n3y4l5; counter[1] += difference_num(difference_set(n0n1n2n3y4l5,difference_set(n0n1n2n3y4l5,difference_set(n0n1n2n3y4l5,y4l5, y0l5), y1l5), y2l5), y3l5);
            }
          }
        }
      }
...
const uint64_t data_complexity = 4.19453e+09;
const uint64_t time_complexity = 3.0323e+09;
