    ...
    for(vidType v0:l0)    {
      ...
      for(vidType v1:y0l1)      {
        ...
        for(vidType v2:y0y1l2)        {
          ...
          for(vidType v3:y0y1n2l4)          {
            VertexSet y3l3 = g.N(v3,3);
            counter[0] += difference_num(y0n1y2l3, y3l3);
          }
        }
      }
      for(vidType v1:y0l2)      {
    ...
    for(vidType v0:l1)    {
      ...
      for(vidType v1:y0l0)      {
        ...
        for(vidType v2:y0y1l2)        {
          ...
          for(vidType v3:y0y1n2l4)          {
            VertexSet y3l3 = g.N(v3,3);
            counter[1] += difference_num(n0y1y2l3, y3l3);
          }
        }
      }
      for(vidType v1:y0l2)      {
...
const uint64_t data_complexity = 1.67748e+09;
const uint64_t time_complexity = 1.20111e+09;
