      ...
      for(vidType v1:y0l1)      {
        ...
        for(vidType v2:y0y1l2)        {
          ...
          for(vidType v3:y0y1y2l3)          {
            ...
            counter[0] += difference_num(y0y1y2l4, y3l4);
          }
        }
      }
      for(vidType v1:y0l2)      {
        ...
        for(vidType v2:y0y1l1)        {
          ...
          for(vidType v3:y0y1y2l3)          {
            VertexSet y3l4 = g.N(v3,4);
            counter[1] += difference_num(y0y1y2l4, y3l4);
          }
        }
      }
      for(vidType v1:y0l3)      {
...
const uint64_t data_complexity = 1.78129e+09;
const uint64_t time_complexity = 1.65204e+09;
