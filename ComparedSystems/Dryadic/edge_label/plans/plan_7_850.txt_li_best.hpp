      ...
      for(vidType v1:y0l1)      {
        ...
        for(vidType v2:y0y1l2)        {
          ...
          for(vidType v3:y0y1y2l3)          {
            ...
            VertexSet y0y1y2n3l4 = difference_set(y0y1y2l4, y3l4);
            ...
            for(vidType v4:y0y1y2y3l5)            {
              ...
              VertexSet y0y1y2n3y4l4 = intersection_set(y0y1y2n3l4, y4l4);
              VertexSet y4l6 = g.N(v4,6);
              VertexSet y0y1y2y3n4l6 = difference_set(y0y1y2y3l6, y4l6);
              for(vidType v5:y0y1y2n3y4l4)              {
                VertexSet y5l6 = g.N(v5,6);
                counter[0] += intersection_num(y0y1y2y3n4l6, y5l6);
              }
            }
          }
        }
        ...
        for(vidType v2:y0y1l1)        {
          ...
          for(vidType v3:y0y1y2l3)          {
            ...
            for(vidType v4:y0y1y2y3l5)            {
              ...
              for(vidType v5:y0y1y2n3y4l4)              {
                VertexSet y5l6 = g.N(v5,6);
                counter[1] += intersection_num(y0y1y2y3n4l6, y5l6);
              }
            }
          }
        }
        ...
        for(vidType v2:y0y1l1)        {
          ...
          for(vidType v3:y0y1y2l2)          {
            ...
            for(vidType v4:y0y1y2y3l3)            {
              VertexSet y4l4 = g.N(v4,4);
              VertexSet y0y1y2y3n4l4 = difference_set(y0y1y2y3l4, y4l4);
              VertexSet y4l6 = g.N(v4,6);
              VertexSet y0n1y2y3y4l6 = intersection_set(y0n1y2y3l6, y4l6);
              for(vidType v5:y0y1y2y3n4l4)              {
                VertexSet y5l6 = g.N(v5,6);
                counter[1] += intersection_num(y0n1y2y3y4l6, y5l6);
              }
            }
          }
        }
        ...
        for(vidType v2:y0y1l1)        {
          ...
          for(vidType v3:y0y1y2l2)          {
            ...
            for(vidType v4:y0y1y2y3l3)            {
              ...
              VertexSet y0y1y2y3n4l4 = difference_set(y0y1y2y3l4, y4l4);
              VertexSet y4l6 = g.N(v4,6);
              VertexSet n0y1y2y3y4l6 = intersection_set(n0y1y2y3l6, y4l6);
              for(vidType v5:y0y1y2y3n4l4)              {
                VertexSet y5l6 = g.N(v5,6);
                counter[1] += intersection_num(n0y1y2y3y4l6, y5l6);
              }
            }
          }
        }
...
const uint64_t data_complexity = 6.07589e+09;
const uint64_t time_complexity = 5.78623e+09;
