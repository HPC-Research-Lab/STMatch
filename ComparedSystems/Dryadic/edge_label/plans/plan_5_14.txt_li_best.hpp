    ...
    for(vidType v0:l0)    {
      ...
      for(vidType v1:y0l4)      {
        ...
        for(vidType v2:y0y1l1)        {
          ...
          VertexSet y2l3 = g.N(v2,3);
          VertexSet y0n1n2l3 = difference_set(y0n1l3, y2l3);
          for(vidType v3:y0n1n2l3)          {
            VertexSet y3l2 = g.N(v3,2);
            counter[1] += intersection_num(n0n1y2l2, y3l2);
          }
        }
      }
    }
...
const uint64_t data_complexity = 3.39994e+09;
const uint64_t time_complexity = 3.02575e+09;
