    ...
    for(vidType v0:l0)    {
      ...
      for(vidType v1:y0l1)      {
        ...
        for(vidType v2:y0y1l4)        {
          ...
          for(vidType v3:y0y1y2l2)          {
            ...
            VertexSet y0n1y2n3l3 = difference_set(y0n1y2l3, y3l3);
            VertexSet y3l5 = g.N(v3,5);
            VertexSet y0y1y2y3l5 = intersection_set(y0y1y2l5, y3l5);
            VertexSet y3l6 = g.N(v3,6);
            VertexSet y0y1n2y3l6 = intersection_set(y0y1n2l6, y3l6);
            for(vidType v4:y0y1y2y3l5)            {
              VertexSet y4l3 = g.N(v4,3);
              VertexSet y0n1y2n3y4l3 = intersection_set(y0n1y2n3l3, y4l3);
              VertexSet y4l6 = g.N(v4,6);
              VertexSet y0y1n2y3n4l6 = difference_set(y0y1n2y3l6, y4l6);
              for(vidType v5:y0y1n2y3n4l6)              {
                VertexSet y5l3 = g.N(v5,3);
                counter[0] += intersection_num(y0n1y2n3y4l3, y5l3);
              }
            }
          }
        }
        ...
        for(vidType v2:y0y1l4)        {
          ...
          for(vidType v3:y0y1y2l1)          {
            ...
            for(vidType v4:y0y1y2y3l5)            {
              ...
              for(vidType v5:y0y1n2y3n4l6)              {
                VertexSet y5l3 = g.N(v5,3);
                counter[1] += intersection_num(y0n1y2n3y4l3, y5l3);
              }
            }
          }
        }
      ...
      for(vidType v1:y0l4)      {
        ...
        for(vidType v2:y0y1l1)        {
          ...
          for(vidType v3:y0y1y2l2)          {
            VertexSet y3l3 = g.N(v3,3);
            VertexSet y0y1n2n3l3 = difference_set(y0y1n2l3, y3l3);
            VertexSet y3l5 = g.N(v3,5);
            VertexSet y0y1y2y3l5 = intersection_set(y0y1y2l5, y3l5);
            VertexSet y3l6 = g.N(v3,6);
            VertexSet y0n1y2y3l6 = intersection_set(y0n1y2l6, y3l6);
            for(vidType v4:y0y1y2y3l5)            {
              VertexSet y4l3 = g.N(v4,3);
              VertexSet y0y1n2n3y4l3 = intersection_set(y0y1n2n3l3, y4l3);
              VertexSet y4l6 = g.N(v4,6);
              VertexSet y0n1y2y3n4l6 = difference_set(y0n1y2y3l6, y4l6);
              for(vidType v5:y0n1y2y3n4l6)              {
                VertexSet y5l3 = g.N(v5,3);
                counter[1] += intersection_num(y0y1n2n3y4l3, y5l3);
              }
            }
          }
        }
    ...
    for(vidType v0:l1)    {
      ...
      for(vidType v1:y0l0)      {
        ...
        for(vidType v2:y0y1l4)        {
          ...
          for(vidType v3:y0y1y2l2)          {
            VertexSet y3l3 = g.N(v3,3);
            VertexSet n0y1y2n3l3 = difference_set(n0y1y2l3, y3l3);
            VertexSet y3l5 = g.N(v3,5);
            VertexSet y0y1y2y3l5 = intersection_set(y0y1y2l5, y3l5);
            VertexSet y3l6 = g.N(v3,6);
            VertexSet y0y1n2y3l6 = intersection_set(y0y1n2l6, y3l6);
            for(vidType v4:y0y1y2y3l5)            {
              VertexSet y4l3 = g.N(v4,3);
              VertexSet n0y1y2n3y4l3 = intersection_set(n0y1y2n3l3, y4l3);
              VertexSet y4l6 = g.N(v4,6);
              VertexSet y0y1n2y3n4l6 = difference_set(y0y1n2y3l6, y4l6);
              for(vidType v5:y0y1n2y3n4l6)              {
                VertexSet y5l3 = g.N(v5,3);
                counter[1] += intersection_num(n0y1y2n3y4l3, y5l3);
              }
            }
          }
        }
      ...
      for(vidType v1:y0l2)      {
        ...
        for(vidType v2:y0y1l0)        {
          VertexSet y2l3 = g.N(v2,3);
          VertexSet n0n1y2l3; difference_set(n0n1y2l3,difference_set(n0n1y2l3,y2l3, y0l3), y1l3);
          VertexSet y2l4 = g.N(v2,4);
          VertexSet y0y1y2l4 = intersection_set(y0y1l4, y2l4);
          VertexSet y2l5 = g.N(v2,5);
          VertexSet y0y1y2l5 = intersection_set(y0y1l5, y2l5);
          ...
          for(vidType v3:y0y1y2l4)          {
            VertexSet y3l3 = g.N(v3,3);
            VertexSet n0n1y2y3l3 = intersection_set(n0n1y2l3, y3l3);
            VertexSet y3l5 = g.N(v3,5);
            VertexSet y0y1y2y3l5 = intersection_set(y0y1y2l5, y3l5);
            VertexSet y3l6 = g.N(v3,6);
            VertexSet y0y1y2n3l6 = difference_set(y0y1y2l6, y3l6);
            for(vidType v4:y0y1y2y3l5)            {
              VertexSet y4l3 = g.N(v4,3);
              VertexSet n0n1y2y3y4l3 = intersection_set(n0n1y2y3l3, y4l3);
              VertexSet y4l6 = g.N(v4,6);
              VertexSet y0y1y2n3n4l6 = difference_set(y0y1y2n3l6, y4l6);
              for(vidType v5:y0y1y2n3n4l6)              {
                VertexSet y5l3 = g.N(v5,3);
                counter[1] += intersection_num(n0n1y2y3y4l3, y5l3);
              }
            }
          }
        }
      ...
      for(vidType v1:y0l0)      {
        ...
        for(vidType v2:y0y1l1)        {
          ...
          for(vidType v3:y0y1y2l2)          {
            ...
            VertexSet y0y1y2y3l5 = intersection_set(y0y1y2l5, y3l5);
            VertexSet y3l6 = g.N(v3,6);
            VertexSet n0y1y2y3l6 = intersection_set(n0y1y2l6, y3l6);
            for(vidType v4:y0y1y2y3l5)            {
              VertexSet y4l3 = g.N(v4,3);
              VertexSet y0y1n2n3y4l3 = intersection_set(y0y1n2n3l3, y4l3);
              VertexSet y4l6 = g.N(v4,6);
              VertexSet n0y1y2y3n4l6 = difference_set(n0y1y2y3l6, y4l6);
              for(vidType v5:n0y1y2y3n4l6)              {
                VertexSet y5l3 = g.N(v5,3);
                counter[1] += intersection_num(y0y1n2n3y4l3, y5l3);
              }
            }
        ...
        for(vidType v2:y0y1l0)        {
          ...
          for(vidType v3:y0y1y2l1)          {
            ...
            for(vidType v4:y0y1y2y3l2)            {
              VertexSet y4l3 = g.N(v4,3);
              VertexSet y0y1y2n3n4l3 = difference_set(y0y1y2n3l3, y4l3);
              VertexSet y4l6 = g.N(v4,6);
              VertexSet n0n1y2y3y4l6 = intersection_set(n0n1y2y3l6, y4l6);
              for(vidType v5:y0y1y2n3n4l3)              {
                VertexSet y5l6 = g.N(v5,6);
...
const uint64_t data_complexity = 6.15956e+09;
const uint64_t time_complexity = 5.10403e+09;
