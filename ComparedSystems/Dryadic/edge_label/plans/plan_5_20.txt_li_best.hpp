      ...
      for(vidType v1:y0l1)      {
        ...
        for(vidType v2:y0y1l2)        {
          ...
          for(vidType v3:y0y1y2l3)          {
            ...
            counter[0] += intersection_num(y0y1y2l4, y3l4);
          }
        }
      }
      for(vidType v1:y0l2)      {
        ...
        for(vidType v2:y0y1l1)        {
          ...
          for(vidType v3:y0y1y2l3)          {
            VertexSet y3l4 = g.N(v3,4);
            counter[1] += intersection_num(y0y1y2l4, y3l4);
          }
        }
      }
      for(vidType v1:y0l3)      {
      ...
      for(vidType v1:y0l4)      {
        ...
        for(vidType v2:y0y1l1)        {
          ...
          for(vidType v3:y0y1y2l2)          {
            ...
            counter[1] += intersection_num(y0y1y2l3, y3l3);
          }
        }
      }
    }
      ...
      for(vidType v1:y0l4)      {
        ...
        for(vidType v2:y0y1l0)        {
          ...
          for(vidType v3:y0y1y2l1)          {
            ...
            counter[1] += intersection_num(y0y1y2l2, y3l2);
          }
        }
      }
    }
...
const uint64_t data_complexity = 1.6375e+09;
const uint64_t time_complexity = 1.82513e+09;
