          ...
          for(vidType v3:y0y1y2l3)          {
            ...
            for(vidType v4:y0y1y2y3l4)            {
              ...
              for(vidType v5:y0y1y2y3y4l5)              {
                ...
                counter[0] += difference_num(y0y1y2n3n4l6, y5l6);
              }
            }
          }
        }
        ...
        for(vidType v2:y0y1l1)        {
          ...
          for(vidType v3:y0y1y2l3)          {
            ...
            for(vidType v4:y0y1y2y3l4)            {
              ...
              for(vidType v5:y0y1y2y3y4l5)              {
                VertexSet y5l6 = g.N(v5,6);
                counter[1] += difference_num(y0y1y2n3n4l6, y5l6);
              }
            }
          }
        }
        ...
        for(vidType v2:y0y1l1)        {
          ...
          for(vidType v3:y0y1y2l2)          {
            ...
            for(vidType v4:y0y1y2y3l4)            {
              ...
              for(vidType v5:y0y1y2y3y4l5)              {
                VertexSet y5l6 = g.N(v5,6);
                counter[1] += difference_num(y0n1y2y3n4l6, y5l6);
              }
            }
          }
        }
    ...
    for(vidType v0:l3)    {
        ...
        for(vidType v2:y0y1l1)        {
          ...
          for(vidType v3:y0y1y2l2)          {
            ...
            for(vidType v4:y0y1y2y3l4)            {
              ...
              for(vidType v5:y0y1y2y3y4l5)              {
                VertexSet y5l6 = g.N(v5,6);
                counter[1] += difference_num(n0y1y2y3n4l6, y5l6);
              }
            }
          }
        }
      ...
      for(vidType v1:y0l4)      {
        ...
        for(vidType v2:y0y1l5)        {
          ...
          VertexSet y0y1y2l2 = intersection_set(y0y1l2, y2l2);
          VertexSet y2l6 = g.N(v2,6);
          for(vidType v3:y0y1y2l0)          {
            VertexSet y3l1 = g.N(v3,1);
            VertexSet y0y1y2y3l1 = intersection_set(y0y1y2l1, y3l1);
            VertexSet y3l2 = g.N(v3,2);
            VertexSet y0y1y2y3l2 = intersection_set(y0y1y2l2, y3l2);
            VertexSet y3l6 = g.N(v3,6);
            VertexSet n0n1n2y3l6; difference_set(n0n1n2y3l6,difference_set(n0n1n2y3l6,difference_set(n0n1n2y3l6,y3l6, y0l6), y1l6), y2l6);
            for(vidType v4:y0y1y2y3l1)            {
              VertexSet y4l2 = g.N(v4,2);
              VertexSet y0y1y2y3y4l2 = intersection_set(y0y1y2y3l2, y4l2);
              VertexSet y4l6 = g.N(v4,6);
              VertexSet n0n1n2y3y4l6 = intersection_set(n0n1n2y3l6, y4l6);
              for(vidType v5:y0y1y2y3y4l2)              {
                VertexSet y5l6 = g.N(v5,6);
                counter[1] += intersection_num(n0n1n2y3y4l6, y5l6);
              }
            }
          }
        }
...
const uint64_t data_complexity = 5.71987e+09;
const uint64_t time_complexity = 5.33272e+09;
