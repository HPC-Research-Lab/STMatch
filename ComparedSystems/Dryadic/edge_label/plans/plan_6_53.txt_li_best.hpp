        ...
        for(vidType v2:y0n1l3)        {
          ...
          for(vidType v3:y0n1y2l1)          {
            ...
            for(vidType v4:y0n1y2y3l2)            {
              ...
              counter[1] += intersection_num(n0n1n2y3l4, y4l4);
            }
          }
        }
      }
...
const uint64_t data_complexity = 3.45858e+09;
const uint64_t time_complexity = 2.52749e+09;
