      ...
      for(vidType v1:y0l1)      {
        ...
        for(vidType v2:y0y1l3)        {
          ...
          for(vidType v3:y0y1n2l4)          {
            ...
            counter[0] += intersection_num(y0n1y2l2, y3l2);
          }
        }
      }
      for(vidType v1:y0l2)      {
        ...
        for(vidType v2:y0y1l3)        {
          ...
          for(vidType v3:y0y1n2l4)          {
            ...
            counter[1] += intersection_num(y0n1y2l1, y3l1);
          }
        }
      }
      for(vidType v1:y0l3)      {
        ...
        for(vidType v2:y0y1l1)        {
          ...
          for(vidType v3:y0y1n2l2)          {
            ...
            counter[1] += intersection_num(y0n1y2l4, y3l4);
          }
        }
      }
      for(vidType v1:y0l4)      {
    ...
    for(vidType v0:l1)    {
      ...
      for(vidType v1:y0l0)      {
        ...
        for(vidType v2:y0y1l3)        {
          ...
          for(vidType v3:y0y1n2l4)          {
            VertexSet y3l2 = g.N(v3,2);
            counter[1] += intersection_num(n0y1y2l2, y3l2);
          }
        }
      }
      for(vidType v1:y0l3)      {
    ...
    for(vidType v0:l2)    {
      ...
      for(vidType v1:y0l0)      {
        ...
        for(vidType v2:y0y1l3)        {
          ...
          for(vidType v3:y0y1n2l4)          {
            VertexSet y3l1 = g.N(v3,1);
            counter[1] += intersection_num(n0y1y2l1, y3l1);
          }
        }
      }
      for(vidType v1:y0l3)      {
    ...
    for(vidType v0:l3)    {
      ...
      for(vidType v1:y0l0)      {
        ...
        for(vidType v2:y0y1l1)        {
          ...
          for(vidType v3:y0y1n2l2)          {
            VertexSet y3l4 = g.N(v3,4);
            counter[1] += intersection_num(n0y1y2l4, y3l4);
          }
        }
      }
      for(vidType v1:y0l1)      {
...
const uint64_t data_complexity = 1.92535e+09;
const uint64_t time_complexity = 1.47901e+09;
